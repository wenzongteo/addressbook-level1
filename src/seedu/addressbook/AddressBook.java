...
public class AddressBook {
    ...
    private static final String COMMAND_ARRANGE_WORD = "arrange";
    private static final String COMMAND_ARRANGE_DESC = "rearrange list in ascending or descending order";
    private static final String COMMAND_ARRANGE_PARAMETERS = "asc | dsc";
    private static final String COMMAND_ARRANGE_WORD_EXAMPLE = COMMAND_ARRANGE_WORD + "asc";

    private static final String COMMAND_UPDATE_WORD = "update";
    private static final String COMMAND_UPDATE_DESC = "update the phone and email of person";
    ...
    */
    ...
    private static String executeCommand(String userInputString) {
        ...
        switch (commandType) {
            ...
            case COMMAND_ARRANGE_WORD:
                return executeRearrangement(commandArgs);
    ...
    */
    ...
    private static String executeRearrangement(String commandArgs){
        if (commandArgs.equalsIgnoreCase("asc") || commandArgs.equalsIgnoreCase("dsc")){
            if (commandArgs.equalsIgnoreCase("asc")){
                arrangeASC();
            } else { //Dsc order
                arrangeDSC();
            }
            ...
            return getMessageForInvalidCommandInput(COMMAND_ARRANGE_WORD, getUsageInfoForAddCommand());
        }
    }


    public static void arrangeDSC(){
    ...
    private static String executeUpdate(String commandArgs){
        ...
        final Set<String> keywords = extractKeywordsFromFindPersonArgs(personToUpdate[0]); //0 is the name of the person

        final ArrayList<String[]> personsFound = getPersonsWithNameContainingAnyKeyword(keywords);

        String[] currDetails = personsFound.get(0); //Should be the only person found. Maybe should perform some validation to ensure.

        currDetails[1] = personToUpdate[1];
        currDetails[2] = personToUpdate[2];
    ...
    */
    ...
    private static void updatePersonsToFile(ArrayList<String[]> persons, String filePath) {
        final ArrayList<String> linesToWrite = encodePersonsToStrings(persons);
        try {
            Files.write(Paths.get(storageFilePath), linesToWrite);
        } catch (IOException ioe) {
    ...
    /**
     * Return usage info for update command
     *
     */
    ...
    /*
        Returns String for showing 'arrange' command usage instruction.
    */
    private static String getUsageInfoForArrangeCommand(){
        return String.format(MESSAGE_COMMAND_HELP,COMMAND_ARRANGE_WORD,COMMAND_ARRANGE_DESC) + LS
                + String.format(MESSAGE_COMMAND_HELP_PARAMETERS,COMMAND_ARRANGE_PARAMETERS) + LS
                + String.format(MESSAGE_COMMAND_HELP_EXAMPLE,COMMAND_ARRANGE_WORD_EXAMPLE) + LS;
    }
    /**
